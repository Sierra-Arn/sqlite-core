...
class BaseRepository(Generic[ModelType]):
    ...
    def get(self, obj_id: int) -> ModelType | None:
        ...
        are not loaded until accessed. Safe in an sync context as long as 
        the session remains open and no relationship attributes are accessed 
    ...
    def update(self, obj_id: int, obj_data: dict[str, Any]) -> ModelType | None:
        """
